...
import { CreditCard, Filter, LayoutDashboard, MapPin, Megaphone, Plug, ScanLine, ShieldCheck, Ticket, Users } from "lucide-react";
...
export default function Sidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  const navItems = [
    ...
    { name: t("integrations"), href: "/business/integrations", icon: Plug },
